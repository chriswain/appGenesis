...
class ViewController: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    func showMoreInfo(shotCaller: UIButton) {
        ...
        var staticCategoryLabel = UILabel(frame: CGRectMake(100, 80, 100, 20))
        ...
        var staticAddressLabel = UILabel(frame: CGRectMake(100, 180, 100, 20))
        ...
        if let categories = venue["categories"] as? [[String:AnyObject]] {
            ...
            let categoriesName = insideCategoriesArray["name"]
